...
public class MainController {
	...
	public String validateUser(@ModelAttribute("user") User user,  Model mv) {
		...
		if(user1!=null) {
			...
			return "redirect:/alloptionpage.jsp";
		}else {
	...
	public String saveUser(@ModelAttribute("user") User user, ModelAndView mv, @RequestParam("pic") MultipartFile file) throws IOException {
		...
		return "redirect:/alloptionpage.jsp";// should go to alloptionpage
